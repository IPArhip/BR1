...
{REDUND_ERROR} FUNCTION_BLOCK FB_Motor (*МОТОР*) (*$GROUP=User,$CAT=User,$GROUPICON=User.png,$CATICON=User.png*)
	VAR_INPUT
	...
	END_VAR
	VAR
		dt : REAL := 0.01; (*Шаг расчёта, с*)
		ke : REAL := 208.33; (*Постоянная ЭДС двигателя, В*мин/об*)
		Tm : REAL := 0.03; (*Электромеханическая постоянная времени, с*)
		integrator : FB_Integrator; (*Интегратор*)
	END_VAR
END_FUNCTION_BLOCK

{REDUND_ERROR} FUNCTION_BLOCK FB_Regulator (*РЕГУЛЯТОР*) (*$GROUP=User,$CAT=User,$GROUPICON=User.png,$CATICON=User.png*)
	VAR_INPUT
